...
default_image_folder = path + "/Image"      # file path to images
...
def display_home_screen():
    ...
    timer_UI = pygame.image.load(path + '/UI/timer.png')
    ...
    camera_UI = pygame.image.load(path + '/UI/camera.png')
...
def display_image_selection_screen():
    ...
    home_UI = pygame.image.load(path + '/UI/home.png')
...
def display_timer_screen():
    ...
    image_UI = pygame.image.load(path + '/UI/camera.png')
    ...
    play_UI = pygame.image.load(path + '/UI/play.png')
    ...
    stop_UI = pygame.image.load(path + '/UI/stop.png')
    ...
    reset_UI = pygame.image.load(path + '/UI/reset.png')
